...
let {createArticle,readMore,deleteArticle,likeArticle,dislikeArticle,editArticle,changeArticle,seeMyArticle,displayCategoryArticle} = require('../controllers/articleController');
...
router.get('/testHP',(req,res)=>{res.render('testHP')});
